...
const REVIEWS = [
  {
    ...
    rating: 5,
    date: "2024년 11월",
    text: "진짜로 플레이스 순위가 올라갔어요. 처음에는 반신반의했는데 3개월 만에 Top 3 들어왔습니다. 주말 예약이 꽉 차는 걸 처음 경험해봤어요.",
    result: "방문객 +167%",
    months: "3개월",
  },
  {
    ...
    rating: 5,
    date: "2024년 10월",
    text: "다른 대행사에서 2년 동안 효과를 못 봤는데 하랑은 달랐어요. 대표님이 직접 저희 병원 특성을 파악하고 전략을 짜주셨어요. 신규 예약이 300% 넘게 늘었습니다.",
    result: "신규 예약 +300%",
    months: "4개월",
  },
  {
    ...
    rating: 5,
    date: "2024년 09월",
    text: "초진 예약 문의가 갑자기 쏟아져서 당황했어요. 리뷰도 거의 없었는데 두 달 만에 95개가 쌓이니까 환자 신뢰도가 완전히 달라졌습니다.",
    result: "초진 예약 +200%",
    months: "2개월",
  },
  {
    ...
    rating: 5,
    date: "2024년 08월",
    text: "전에는 SNS 직접 하다가 너무 힘들어서 맡겼는데, 맡기자마자 예약이 꽉 찼어요. 이제 마케팅 걱정 없이 시술에만 집중할 수 있어서 너무 좋아요.",
    result: "예약 완전 마감",
    months: "2개월",
  },
  {
    ...
    rating: 5,
    date: "2024년 07월",
    text: "배달 매출이 안 나와서 고민이었는데 플레이스 최적화 한 달 만에 주문이 두 배로 늘었어요. 재계약 당연히 했습니다. 솔직하게 말씀해주시는 게 제일 마음에 들어요.",
    result: "배달 매출 +113%",
    months: "1개월",
  },
  {
    ...
    rating: 5,
    date: "2024년 06월",
    text: "수강생이 한 명도 안 늘어서 폐업 고민까지 했었어요. 지금은 대기 신청을 받을 정도예요. 포기하지 않길 잘했어요.",
    result: "수강생 +55%",
    months: "3개월",
  },
];
