...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/beauty-instagram-follower`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/google-maps-seo`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/keyword-research-local`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/review-response-templates`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/academy-marketing-guide`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
